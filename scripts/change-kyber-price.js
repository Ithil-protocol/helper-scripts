...
async function main() {
  ...
  const KYBER_ABI = require("@ithil-protocol/deployed/"+network+"/abi/MockKyberNetworkProxy.json");
  ...
  const kyber = new ethers.Contract(addresses.MockKyberNetworkProxy, KYBER_ABI, signer);
